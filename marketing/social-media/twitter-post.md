...
🐍 Built a Docker-free OCI image builder for Python projects
...
❌ Docker Desktop
❌ Writing Dockerfiles
❌ Understanding Docker-specific concepts
...
**Tweet 3:**
Current features:
✅ Registry push (GHCR, ACR, Docker Hub)
✅ Smart base image selection
✅ Layer caching
✅ SBOM generation
✅ FastAPI/Flask/Django auto-detection
✅ Poetry & Hatch plugins
...
Drop comments or open an issue! 💬
...
```
🐍 pycontainer-build: Native Python OCI image builder
